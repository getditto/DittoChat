...
describe('RBAC Slice', () => {
  ...
  describe('Custom Permissions', () => {
    ...
    it('should handle all permissions set to false', () => {
      ...
      expect(restrictiveState.canPerformAction('canDeleteOwnMessage')).toBe(
        false,
      )
      expect(restrictiveState.canPerformAction('canAddReaction')).toBe(false)
      expect(restrictiveState.canPerformAction('canRemoveOwnReaction')).toBe(
        false,
      )
      expect(restrictiveState.canPerformAction('canMentionUsers')).toBe(false)
      expect(restrictiveState.canPerformAction('canSubscribeToRoom')).toBe(
        false,
      )
    })
