...
describe("MessageBubble", () => {
    ...
    it("renders image attachment", () => {
        const imageMessage: Message = {
            ...mockMessage,
            thumbnailImageToken: { id: "token-1", len: 0, metadata: {} } as Attachment,
        };
    ...
    it("renders file attachment", () => {
        const fileMessage: Message = {
            ...mockMessage,
            fileAttachmentToken: { id: "token-2", len: 0, metadata: {} } as Attachment,
            text: "document.pdf",
        };
    ...
    it("handles reaction removal", () => {
        ...
        expect(defaultProps.onRemoveReaction).toHaveBeenCalledWith(reactionMessage, "user-2", "👍");
    });
    ...
    it("handles thumbnail click to show large image", () => {
        ...
        const imageMessage: Message = {
            ...mockMessage,
            thumbnailImageToken: { id: "token-1", len: 0, metadata: {} } as Attachment,
            largeImageToken: { id: "token-large", len: 0, metadata: {} } as Attachment,
        };
    ...
    it("shows loading state for large image", () => {
        mockUseImageAttachment.mockImplementation((args: Parameters<typeof useImageAttachment>[0]): UseImageAttachmentReturn => {
            ...
            return { imageUrl: "thumb", progress: 1, isLoading: false, error: null, fetchImage: vi.fn() };
        });
    ...
    it("shows deleted file placeholder", () => {
        const deletedFileMessage: Message = {
            ...mockMessage,
            text: "file.pdf",
            fileAttachmentToken: { id: "file-token", len: 0, metadata: {} } as Attachment,
            isDeleted: true,
        };
    ...
    it("handles file download success", () => {
        const fetchAttachmentMock = vi.fn().mockImplementation((token, onProgress, onComplete) => {
