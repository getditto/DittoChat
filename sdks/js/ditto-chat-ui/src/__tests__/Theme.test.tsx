...
describe('DittoChatUI Theme Customization', () => {
    ...
    it('applies theme values to CSS variables when a theme object is passed', () => {
        ...
        expect(rootElement.style.getPropertyValue('--dc-primary-color')).toBe('#ff0000')
        expect(rootElement.style.getPropertyValue('--dc-surface-color')).toBe('#00ff00')
        expect(rootElement.style.getPropertyValue('--dc-text-color')).toBe('#0000ff')
    })
