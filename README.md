...
**[@dittolive/ditto-chat-core](./sdks/js/DittoChatCore)** - Core data models and React hooks for real-time chat functionalities
```bash
...
**[@dittolive/ditto-chat-ui](./sdks/js/DittoChatUI)** - Ready-to-use React components for building chat UIs
```bash
